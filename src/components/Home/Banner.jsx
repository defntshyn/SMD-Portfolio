    ...
    <div className="content-banner">
      ...
      <div className="banner-details">
        ...
        <div className="social">
          <p>Connect:</p>
          <a href="https://www.facebook.com/LazyPotatooo.8" target='_blank'><i className="fa-brands fa-facebook"></i></a>
          <a href="https://www.linkedin.com/in/shaynemichaeldanos/" target='_blank'><i className="fa-brands fa-linkedin"></i></a>
          <a href="https://github.com/defntshyn" target='_blank'><i class="fa-brands fa-github"></i></a>
        </div>
      </div>
    </div>
  );
